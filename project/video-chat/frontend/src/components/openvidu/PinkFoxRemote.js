...
const PinkFoxRemote = ({ landmarks, videoElement }) => {
        ...
        {landmarks && (
          <>
           <ShapeComponent landmarks={landmarks} indices={faceOutlineIndices1} color="white" />
            ...
            <ShapeComponent landmarks={landmarks} indices={RedEye1} color="pink" />
            <ShapeComponent landmarks={landmarks} indices={RedEye2} color="pink" />
            <ShapeComponent landmarks={landmarks} indices={head} color="pink" />
            <LineComponent landmarks={landmarks} indices={faceline} color="pink" lineWidth={3.5} /> 
            <LineComponent landmarks={landmarks} indices={faceline2} color="pink" lineWidth={3.5} /> 
            <LineComponent landmarks={landmarks} indices={faceline3} color="pink" lineWidth={3.5} /> 
            <LineComponent landmarks={landmarks} indices={faceline4} color="pink" lineWidth={3.5} /> 
