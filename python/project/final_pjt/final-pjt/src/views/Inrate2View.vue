<template>
  <div class="ms-2 me-2">
    <div class="interest-rate-container mt-5">
      <h2 class="mt-4 fw-bold">적금 상품 금리 비교</h2>
      <div class="d-flex justify-content-center align-items-center">
        <div>
          <a class="choose-item m-1 p-1 fw-bold" @click.prevent="gotoInrate">예금보기</a>
        </div>
        <div>
          <a class="activeChoose m-1 p-1 fw-bold" @click.prevent="gotoInrate2">적금보기</a>
        </div>
      </div>
      <div class="table-header mt-5 align-items-center">
        ...
        <span class="d-flex align-items-center justify-content-end">
          <div>
            <span class="inrate-margin">금리 순으로 정렬</span>
          </div>
          <div>
      ...
      <div class="product-list">
        <div v-for="product in filteredProducts" :key="product.id" class="product-row text-start">
          <div v-if="product.product.kor_co_nm == '수협은행'" class="d-flex justify-content-between">
            <div class="d-flex">
              <div>
            ...
            <div>
              <span class="text-end text-danger rate-font fw-bold">{{ product.intr_rate }}%</span>
            </div>
          </div>
          <div v-else-if="product.product.kor_co_nm == '우리은행'" class="d-flex justify-content-between">
            <div class="d-flex">
              <div>
                <img class="bank-logo-img"
          ...
          <div v-else-if="product.product.kor_co_nm == '전북은행'" class="d-flex justify-content-between">
            <div class="d-flex">
              <div>
                <img class="bank-logo-img"
          ...
          <div v-else-if="product.product.kor_co_nm == '주식회사 케이뱅크'" class="d-flex justify-content-between">
            <div class="d-flex">
              <div>
                <img class="bank-logo-img"
          ...
          <div v-else-if="product.product.kor_co_nm == '농협은행주식회사'" class="d-flex justify-content-between">
            <div class="d-flex">
              <div>
                <img class="bank-logo-img"
          ...
          <div v-else-if="product.product.kor_co_nm == '한국스탠다드차타드은행'" class="d-flex justify-content-between">
            <div class="d-flex">
              <div>
                <img class="bank-logo-img"
          ...
          <div v-else-if="product.product.kor_co_nm == '광주은행'" class="d-flex justify-content-between">
            <div class="d-flex">
              <div>
                <img class="bank-logo-img"
          ...
          <div v-else-if="product.product.kor_co_nm == '주식회사 카카오뱅크'" class="d-flex justify-content-between">
            <div class="d-flex">
              <div>
                <img class="bank-logo-img"
          ...
          <div v-else-if="product.product.kor_co_nm == '제주은행'" class="d-flex justify-content-between">
            <div class="d-flex">
              <div>
                <img class="bank-logo-img"
          ...
          <div v-else-if="product.product.kor_co_nm == '대구은행'" class="d-flex justify-content-between">
            <div class="d-flex">
              <div>
                <img class="bank-logo-img"
          ...
          <div v-else-if="product.product.kor_co_nm == '부산은행'" class="d-flex justify-content-between">
            <div class="d-flex">
              <div>
                <img class="bank-logo-img"
          ...
          <div v-else-if="product.product.kor_co_nm == '신한은행'" class="d-flex justify-content-between">
            <div class="d-flex">
              <div>
                <img class="bank-logo-img"
          ...
          <div v-else-if="product.product.kor_co_nm == '하나은행'" class="d-flex justify-content-between">
            <div class="d-flex">
              <div>
                <img class="bank-logo-img"
          ...
          <div v-else-if="product.product.kor_co_nm == '국민은행'" class="d-flex justify-content-between">
            <div class="d-flex">
              <div>
                <img class="bank-logo-img"
          ...
          <div v-else-if="product.product.kor_co_nm == '한국산업은행'" class="d-flex justify-content-between">
            <div class="d-flex">
              <div>
                <img class="bank-logo-img"
          ...
          <div v-else-if="product.product.kor_co_nm == '중소기업은행'" class="d-flex justify-content-between">
            <div class="d-flex">
              <div>
                <img class="bank-logo-img"
          ...
          <div v-else-if="product.product.kor_co_nm == '경남은행'" class="d-flex justify-content-between">
            <div class="d-flex">
              <div>
                <img class="bank-logo-img"
          ...
          <div v-else-if="product.product.kor_co_nm == '토스뱅크 주식회사'" class="d-flex justify-content-between">
            <div class="d-flex">
              <div>
                <img class="bank-logo-img"
...
axios({
  method: 'get',
  url: 'http://127.0.0.1:8000/savs/saving_products/',
})
  .then(res => {
...
const filteredProducts = computed(() => {
  ...
  const uniqueFiltered = filtered.filter(product => {
    const productIdentifier = `${product.product.fin_prdt_nm}-${product.intr_rate}`
    if (productSet.has(productIdentifier)) {
      return false
    } else if (product.intr_rate != null){
      productSet.add(productIdentifier)
      return true
    }
  })
  return uniqueFiltered.slice().sort((a, b) => {
    return sortOption.value === 'desc' ? b.intr_rate - a.intr_rate : a.intr_rate - b.intr_rate
  })
})
...
const gotoDetail = function (id) {
  router.push({name:'inrate2detail', params:{'id': id}})
}
